...
export const useGetAllMovies = () => useQuery({
  queryKey: ['movies'],
...
export const useMutationSaveMovie = () => useMutation({
...
export const useMutationUpdateMovieById = () => useMutation({
...
// Pessimistic Update
// export const useMutationDeleteMovieById = () => useMutation({
